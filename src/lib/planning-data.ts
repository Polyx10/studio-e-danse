...
export const grilleNiveaux: NiveauConfig[] = [
  ...
  { niveau: 'Classique Ado 2', ageMin: 12, ageMax: 20, coursIds: ['mar-2', 'ven-3'] },
  ...
  { niveau: 'Classique Adulte Avancé', ageMin: 15, ageMax: null, coursIds: ['jeu-4', 'sam-10'] },
  { niveau: 'Classique Adulte Débutant', ageMin: 15, ageMax: null, coursIds: ['ven-5', 'sam-8'] },
  { niveau: 'Contemporain Adulte Avancé', ageMin: 15, ageMax: null, coursIds: ['ven-7'] },
...
export const planningCours: CoursPlanning[] = [
  // LUNDI
  { id: "lun-1", jour: "Lundi", nom: "Classique ADO 1", horaire: "17h45-19h15", duree: 90, professeur: "Romane", salle: "LDN", heureDebut: 1065, heureFin: 1155 },
