...
async function getFiches() {
  try {
    const fiches = await sql`
      SELECT id, titre, texte, photos, photos_legendes, photos_disposition, categorie, highlight, show_date, created_at, lien_bouton_url, lien_bouton_texte, lien_bouton2_url, lien_bouton2_texte
      FROM pages_content
