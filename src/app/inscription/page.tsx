        ...
        <div className="container mx-auto px-4 flex items-start gap-4 text-[#2D3436]">
          ...
          <div>
            ...
            {preinscriptionEffective
              ...
              : <p className="text-sm text-[#2D3436]">Votre inscription sera confirmée lors de votre venue <strong>au secrétariat</strong> pour effectuer votre <strong>premier règlement</strong>, muni(e) du récapitulatif fourni en fin de formulaire.</p>
            }
          </div>
        </div>
      </section>
